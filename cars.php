...
<div class="slider-area slider-style-1 variation-default height-650 bg_image bg_image--20" data-black-overlay="7">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner pt--80 text-left" data-sal="slide-up" data-sal-duration="400" data-sal-delay="150">
                            <!-- <div>
                                <h3 class="rn-sub-badge"><span class="theme-gradient">Our Company's About
                                        Details.</span></h3>
                            </div> -->
                            <h1 class="title display-one">Drive Your Dream <br> Drive Big Impact</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="rn-card box-card-style-default">
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <h4 class="title"><a href="blog-details.html">The Next 100 Things To Immediately Do
                                            About.</a></h4>
                                </div>
                            </div>
                        </div>
